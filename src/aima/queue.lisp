...
;;; Note that this is apparently not intended to act on its on within
;;; the rest of the AIMA codebase. It seems to be provided only for its
;;; use within the enqueue-by-priority procedure.
